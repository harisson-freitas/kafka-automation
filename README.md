...
Antes de executar os testes, é necessário realizar às seguintes configurações:
   ...
   - Abrir o arquivo **_bin/main.sh_** para configurar às varáveis abaixo:
     -  Gerais: <br/>
        ...
        | PATH_MAIN                   | Caminho principal do projeto                                        | Se estiver executando fora de um container: **_${HOME}/kafka-automation_**-podes utilizar a variável $HOME; <br/>Se estiver executando dentro de um container: **_/home/harissonfreitas/kafka-automation_**|
