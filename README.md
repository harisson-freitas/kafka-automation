...
No processo de envio de mensagens, temos às seguintes opções:
 ...
 - **_Arquivo json_**: Cria-se um arquivo Json com à(s) mensage(ns) a serem enviadas para o tópico.
...
Antes de executar os testes, é necessário realizar às seguintes configurações:
   ...
   - Abrir o arquivo **_bin/main.sh_** para configurar às varáveis abaixo:
     -  Gerais: <br/>
        ...
        | PATH_MAIN                   | Caminho principal do projeto                                        | Se estiver executando fora de um container: **_${HOME}/kafka-automation_**-podes utilizar a variável **_$HOME_**; <br/>Se estiver executando dentro de um container: **_/home/harissonfreitas/kafka-automation_**|
        | PATH_JSON                   | Caminho onde está o arquivo .json para teste                        | Se estiver executando fora de um container: **_${HOME}/testes/json_**-podes utilizar a variável **_$HOME_**; <br/>Se estiver executando dentro de um container: **_/home/harissonfreitas/kafka-docker/json_**                              |
...
No Linux podemos tanto executar o server do Kafka localmente, quanto dentro de um container docker. 
